              ...
              <li class="nav-item dropdown">
                  ...
                  <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
                      <a href="#" class="dropdown-item">
                          ...
                          <div class="d-flex">
                              <div class="flex-shrink-0">
                                  <img src="{{ asset('assets/adminlte/img/user1-128x128.jpg') }}" alt=""
                      ...
                      <a href="#" class="dropdown-item">
                          ...
                          <div class="d-flex">
                              <div class="flex-shrink-0">
                                  <img src="{{ asset('assets/tailstore/images/products/8.jpg') }}" alt=""
                                      class="img-size-50 rounded-circle me-3" />
                              </div>
                              <div class="flex-grow-1">
                                  <p class="dropdown-item-title">
                      ...
                      <a href="#" class="dropdown-item">
                          ...
                          <div class="d-flex">
                              <div class="flex-shrink-0">
                                  <img src="{{ asset('assets/adminlte/img/user3-128x128.jpg') }}" alt=""
                                      class="img-size-50 rounded-circle me-3" />
                              </div>
                              <div class="flex-grow-1">
                                  <p class="dropdown-item-title">
